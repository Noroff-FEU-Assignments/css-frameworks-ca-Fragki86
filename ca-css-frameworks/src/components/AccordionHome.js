      ...
      <Accordion defaultActiveKey="0" className="d-md-none">
            ...
            <Card>
                ...
                <Accordion.Collapse eventKey="1">
                    <Card.Body>Morbi eget efficitur turpis. Vivamus pellentesque tortor massa, venenatis pharetra leo laoreet a. Nullam non eleifend justo, a ullamcorper turpis. Cras vehicula pharetra lectus non maximus. Sed condimentum mattis rhoncus. </Card.Body>
                </Accordion.Collapse>
            </Card>
            <Card>
                <Card.Header>
